...
const CaseStudies = () => {
  ...
  return (
    <>
      <section id="portfolio" className="gallery-section-five overlay pt-115 rpt-95 pb-90 rpb-70 px-60 rpx-0">
                ...
                <div className="gallery-item-five wow fadeInUp delay-0-2s">
                  ...
                  <div className="gallery-content">
                    <div className="gallery-content-inner">
                      <Link href={`/portfolio-details/${item.id}`} className="gallery-btn">
