...
import VideoModal from "@/components/modals/modal-video";
            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div className="ready-content">
                  ...
                  <Link href={'/about'} className="theme-btn style-ten hover-two">
                    {ready_btn_text} <i className="far fa-paper-plane"></i>
                  </Link>
                </div>
              </div>
              <div className="col-lg-6">
