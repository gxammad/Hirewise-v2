                  ...
                  <div className="container">
                    <div className="main-slider-content">
                      ...
                      <div className="slider-btns">
                        <Link href={'/about'} className="theme-btn style-ten">
                          {item.btn_text} <i className="far fa-paper-plane"></i>
                        </Link>
                        <Link href={'/about'} className="theme-btn style-eleven">
                          {item.btn_text_2} <i className="far fa-paper-plane"></i>
                        </Link>
                      </div>
                    </div>
                  </div>
