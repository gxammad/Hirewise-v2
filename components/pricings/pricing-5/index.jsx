...
import PricingSection from "../../homes/multipage/home-6/pricing-section";

export default function PricingFiveMain() {
  return (
    <div className='page-wrapper'>
      <HeaderThree />
      <Breadcrumb title={'Pricing Five'} subtitle={'Pricing Five'} />
      <PricingSection/>
      <TestimonialArea />
      <Contact df={true} />
      <FooterTwo/>
